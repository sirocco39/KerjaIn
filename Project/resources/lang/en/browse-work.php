...
return [
    ...
    'js_messages' => [
        ...
        'tawaran_berhasil_dikirim' => 'Offer sent successfully!',
        'kesalahan_mengirim_tawaran' => 'An error occurred while sending the offer.',
        'kesalahan_koneksi' => 'Connection error.',
        'memuat_detail' => 'Loading Details...',
        'silakan_tunggu' => 'Please wait.',
        'gagal_memuat_detail' => 'Failed to Load Details',
        'gagal_memuat_detail_pesan' => 'An error occurred while loading job details. Please try again.',
        'pilih_pekerjaan_dulu' => 'Please select a job first.',
        'kesalahan_memproses' => 'An error occurred while processing the request.',
    ],
