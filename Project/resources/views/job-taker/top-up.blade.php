                ...
                <div class="col-md-7 col-lg-5">
                    ...
                    <div class="card topup-card">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <h3 class="text-center fw-bold mb-4">Isi Saldo</h3>

                            {{-- Bagian Menampilkan Saldo Saat Ini --}}
                            <div class="text-center border rounded p-3 mb-4">
                                <h6 class="text-muted mb-1">Saldo Aktif Anda</h6>
                            ...
                            <form action="{{ route('topup.create') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-text mt-2">Minimum top up adalah Rp10.000.</div>
                                </div>
                    ...
                    <p class="text-center text-muted small mt-4">
                        💡 Saldo akan bertambah secara otomatis setelah pembayaran berhasil.
                    </p>
