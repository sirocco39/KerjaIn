                        ...
                        <div class="w-100">
                            ...
                            <div class="rounded p-4 text-center d-flex flex-column align-items-center justify-content-between"
                                ...
                                <div id="previewContainerReport"
                                    class="d-flex flex-wrap gap-2 justify-content-center mt-3"></div>
                            </div>
                        </div>
    ...
    <script>
        function uploadProof() {
            ...
            if (document.getElementById('photoInputReport').files.length === 0) {
                ...
                return; // Menghentikan eksekusi fungsi jika tidak ada file
            }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const placeholder = document.getElementById('uploadPlaceholder'); // <-- BARU

            // Tambahkan event listener ke input file
            if (photoInput && submitButton && placeholder) {
                photoInput.addEventListener('change', function() {
                    // Cek apakah ada file yang dipilih
                    if (this.files.length > 0) {
                        // Jika ada file:
                        submitButton.disabled = false; // Aktifkan tombol
                        placeholder.style.display = 'none'; // <-- BARU: Sembunyikan placeholder
                    } else {
                        // Jika tidak ada file (dibatalkan):
                        submitButton.disabled = true; // Nonaktifkan tombol
                        placeholder.style.display = 'block'; // <-- BARU: Tampilkan lagi placeholder
                    }
                });
            }
