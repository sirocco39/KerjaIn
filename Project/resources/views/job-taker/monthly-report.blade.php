                        ...
                        @foreach ($jobHistory as $transaction)
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900" style="text-align: center">
                                    {{ $transaction->updated_at->format('d M Y') }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900" style="text-align: center">
                                    {{ $transaction->request->title ?? 'N/A' }}</td> {{-- Assuming 'job_title' on Request --}}
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900" style="text-align: center">
                                    {{ $transaction->request->location ?? 'N/A' }}</td> {{-- Assuming 'location' on Request --}}
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900" style="text-align: center">
