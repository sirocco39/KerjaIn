...
{{-- PERUBAHAN UTAMA DI SINI:
    1. Hapus div `<div class="container">`.
    2. Pindahkan kelas `mb-3` ke div pembungkus `.job-card-wrapper` yang sudah kita buat di file master sebelumnya.
       Ini untuk mengontrol margin antar card dari luar komponen.
    3. Hapus `rounded-5` dari `.card` karena saya akan menambahkannya lagi di CSS dengan `border` dan `box-shadow` yang lebih terkontrol.
--}}
