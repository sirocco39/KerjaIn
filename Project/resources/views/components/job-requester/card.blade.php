...
<style>
    ...
    .chat-item-card:last-child { margin-bottom: 0; }
    .chat-item-card:hover { transform: scale(1.02); }
    .chat-item-card.active { box-shadow: 0 0 0 3px rgba(255, 255, 255, 0.8); }
    .chat-item-avatar {
        width: 50px;
        height: 50px;
    ...
    .chat-item-text { overflow: hidden; }
</style>
