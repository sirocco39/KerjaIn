    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content p-4">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-center gap-2 gap-md-4 mt-4">
                <button type="button" class="btn py-3 fw-semibold rounded-4" style="color:#294287; border-color:#294287; border-width: 2px; width:100%;" data-bs-dismiss="modal">
                    Kembali
                </button>
                <button type="button" class="btn py-3 text-light fw-semibold rounded-4" style="background-color:#309FFF; width:100%;" data-bs-toggle="modal" data-bs-target="#completionModal">
                ...
                <div class="d-flex flex-column flex-lg-row gap-3">
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                        ...
                        <div class="rounded-3 mt-2 mb-4 p-2" style="border-color:#8a8a8a; border-style:solid; width:100%; height:64%; border-width:1px;">
                            <p class="m-0">{{ $completionProof->note ?? 'Tidak ada catatan dari pekerja.' }}</p>
                        </div>
            ...
            <div class="modal-body" style="max-height: 75vh; overflow-y: auto;">
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-3 align-items-start" id="imagePreviewContainer">
                        <div class="pb-2" onclick="document.getElementById('reportImageInput').click()" style="width: 80px; height: 80px; border: 2px dashed #309FFF; background-color: #f7f7ff; display: flex; align-items: center; justify-content: center; cursor: pointer;">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="note" id="reportNote" class="form-control rounded-4" rows="4" placeholder="Ceritakan masalah yang Anda alami..." style="background-color: #f7f7ff;"></textarea>
                </div>
            </div>
