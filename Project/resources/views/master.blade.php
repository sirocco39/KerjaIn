        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapseFull">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="navbarCollapse">
                    <li class="nav-item"><a class="nav-link {{ request()->is('beranda') ? 'active' : '' }}" href="/beranda" aria-current="true">Beranda</a></li>
                    <li class="nav-item"><a class="nav-link {{ request()->is('cari-kerja') ? 'active' : '' }}" href="/cari-kerja">Cari Kerja</a></li>
                    <li class="nav-item"><a class="nav-link {{ request()->is('pesan') ? 'active' : '' }}" href="/pesan">Pesan</a></li>
