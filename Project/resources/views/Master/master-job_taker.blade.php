...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-light fixed-top" id="mainNavbar">
        <div class="container-fluid pembatas-x">
            <a class="navbar-brand" href="/job-taker/beranda">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapseFull">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="navbarCollapse">
                    <li class="nav-item">
                        @auth
                            <a class="nav-link {{ request()->is('job-taker/beranda') ? 'active' : '' }}"
                                href="/job-taker/beranda">Beranda</a>
                        @else
                    ...
                    <li class="nav-item">
                        @auth
                            <a class="nav-link {{ request()->is('job-taker/cari-kerja') ? 'active' : '' }}"
                                href="/job-taker/cari-kerja">Cari Kerja</a>
                        @else
                            <a class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#loginModal">Cari
                                Kerja</a>
                        @endauth
                    </li>
                    <li class="nav-item">
                        @auth
                            <a class="nav-link {{ request()->is('job-taker/pesan') ? 'active' : '' }}"
                                href="/job-taker/pesan">Pesan</a>
                        @else
                    ...
                    <li class="nav-item">
                        @auth
                            <a class="nav-link {{ request()->is('job-taker/riwayat') ? 'active' : '' }}"
                                href="/job-taker/riwayat">Riwayat</a>
                        @else
                            <a class="nav-link" href="#" data-bs-toggle="modal"
        ...
        <div class="row d-flex flex-wrap justify-content-between align-items-start" id="foot-content">
            ...
            <div class="col-6 col-md-3 col-lg-2 foot-content-detail" id="foot-2">
                ...
                <div class="list-group gap-2">
                    ...
                    @else
                        <a href="#" data-bs-toggle="modal" data-bs-target="#loginModal" class="foot-list">Cari
                            Kerja</a>
                    @endauth
